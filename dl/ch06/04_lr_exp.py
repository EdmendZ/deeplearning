"""学习率调度（ExponentialLR）演示：每一步都将学习率按指数衰减 lr = lr * gamma。

指数衰减是一种平滑的连续衰减策略，学习率随迭代逐步、平稳地减小，
没有 StepLR / MultiStepLR 那样的阶梯式突变。
"""
...
if __name__ == '__main__':
    ...
    # ExponentialLR：每一步学习率乘以 gamma（指数级平滑衰减）
